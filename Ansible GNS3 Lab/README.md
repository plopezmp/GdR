...
## Network Automation
Network Automation is a docker system with linux and Ansible installed. The GNS3 appliance is in [Network Automation link](https://www.gns3.com/marketplace/labs/network-automation-3)
